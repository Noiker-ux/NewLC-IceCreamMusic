export const allLanguages = [
  ...
  { value: "cat", label: "Catalan valueencian " },
  ...
  { value: "cpe", label: "Creoles and pidgins " },
  { value: "cpf", label: "Creoles and pidgins " },
  { value: "cpp", label: "Creoles and pidgins " },
  { value: "cre", label: "Cree " },
  { value: "crh", label: "Crimean Tatar Crimean Turkish " },
  ...
  { value: "gez", label: "Geez " },
  { value: "gil", label: "Gilbertese " },
  { value: "gla", label: "Gaelic Scottish Gaelic " },
  { value: "gle", label: "Irish " },
  { value: "glg", label: "Galician " },
  { value: "glv", label: "Manx " },
  { value: "gmh", label: "German " },
  { value: "goh", label: "German " },
  ...
  { value: "gsw", label: "Swiss German Alemannic Alsatian " },
  ...
  { value: "kal", label: "Kalaallisut Greenlandic " },
  ...
  { value: "kua", label: "Kuanyama Kwanyama " },
  ...
  { value: "nav", label: "Navajo Navaho " },
  { value: "nbl", label: "Ndebele " },
  { value: "nde", label: "Ndebele " },
  { value: "ndo", label: "Ndonga " },
  { value: "nds", label: "Low German Low Saxon German " },
  { value: "nep", label: "Nepali " },
  { value: "new", label: "Nepal Bhasa Newari " },
  { value: "nia", label: "Nias " },
  { value: "nic", label: "Niger-Kordofanian languages " },
  { value: "niu", label: "Niuean " },
  { value: "nno", label: "Norwegian Nynorsk Nynorsk " },
  { value: "nob", label: "Bokmål " },
  { value: "nog", label: "Nogai " },
  { value: "non", label: "Norse " },
  ...
  { value: "sai", label: "South American Indian (Other) " },
  ...
  { value: "ton", label: "Tonga (Tonga Islands) " },
