	...
	return (
		<div className='terms'>
			<p className='text-center'>
				<span className='text-3xl font-extrabold'>ПУБЛИЧНАЯ ОФЕРТА</span> <br />{' '}
				о заключении договора об оказании услуг
			</p>
			<p className='font-extrabold'>1. Общие положения</p>
			<p>
			...
			<p>
				...
				условиях присоединения. Термины и определения: Договор – текст настоящей
				Оферты с Приложениями, являющимися неотъемлемой частью настоящей Оферты,
				акцептованный Заказчиком путем совершения конклюдентных действий,
				предусмотренных настоящей Офертой. Конклюдентные действия — это
			...
			<p>
				...
				«Интернет» по доменному имени и сетевому адресу: icecreammusic.ru
			</p>
			...
			<p className='font-extrabold'>2. Предмет Договора</p>
			<ol>
				<li>
				...
				<li>
					...
					<ul>
						...
						<li>
							• оформлении и направлении Заказчиком заявки в адрес Исполнителя
							для оказания Услуг • действиях, связанных с оплатой Услуг
							Заказчиком
						</li>
			...
			<p className='font-extrabold'>3. Права и обязанности Сторон</p>
			<ul>
				<li>
					...
					<ul>
						...
						<li>
							3.1.4. Исполнитель оставляет за собой право изменять сроки
							(период) оказания Услуг и условия настоящей Оферты в одностороннем
							порядке без предварительного уведомления Заказчика, публикуя
							указанные изменения на Сайте Исполнителя в сети «Интернет». При
							этом новые / измененные условия, указываемые на Сайте, действуют
							только в отношении вновь заключаемых Договоров.
						</li>
						<li>
							3.1.5. Исполнитель обязуется, не позднее 1 (одного) дня после
							получения каждой оплаты от Заказчика за оказанные услуги по
							настоящей Оферте, сформировать электронный чек в порядке статьи 14
							Федерального закона от 27.11.2018 N 422-ФЗ и обеспечить его
							передачу Заказчику.
						</li>
						<li>
							3.1.6. В случае снятия Исполнителя со специального налогового
							режима `Налог на профессиональный доход` Исполнитель обязуется
							уведомить об этом Заказчика в двухдневный срок с даты такого
							снятия с учета.
						</li>
					</ul>
				</li>
				<li>
					<span className='font-bold'>3.2. Права и обязанности Заказчика:</span>
					<ul>
						<li>
						...
						<li>
							...
							было целях информацию и материалы, ставшие ему доступными в связи
						...
						<li>
							...
							Российской Федерации. Случаи, порядок и условия возврата денежных
							средств за неоказанные (некачественно оказанные) услуги
							устанавливаются на Сайте Исполнителя в сети «Интернет»:
							icecreammusic.ru. Возврат денежных средств осуществляется на
							основании претензии, срок ответа на претензию – 10 рабочих дней.
						</li>
						<li>
			...
			<p className='font-extrabold'>4. Цена и порядок расчетов</p>
			<ul>
				<li>
			...
			<p className='font-extrabold'>5. Конфиденциальность и безопасность</p>
			<ul>
				<li>
			...
			<p className='font-extrabold'>6. Форс-мажор</p>
			<ul>
				<li>
			...
			<p className='font-extrabold'>7. Ответственность Сторон</p>
			<ul>
				<li>
			...
			<p className='font-extrabold'>8. Срок действия настоящей Оферты</p>
			<ul>
				<li>
			...
			<p className='font-extrabold'>9. Дополнительные условия</p>
			<p>
				В случае нарушения Пользователем условий Договора (ненадлежащего
				исполнения обязательств) Правообладатель вправе в одностороннем порядке
				отказаться от исполнения Договора как полностью, так и в части, в том
				числе:
			</p>
			<p>
				• удалив Контент с Платформы и запросив удаление Контента со
				стриминговых площадок (стоимость удаления одного релиза составляет 750₽,
				расходы несёт Пользователь);
			</p>
			<p>
			...
			<p className='font-extrabold'>10. Реквизиты Исполнителя</p>
			<p>Полное наименование: ICECREAMMUSIC</p>
			<p>ИНН: 391301950740</p>
			<p>Контактный телефон: +7 902 422-66-47</p>
			<p>Контактный e-mail: ckeabrona@yandex.ru</p>
		</div>
	);
}
