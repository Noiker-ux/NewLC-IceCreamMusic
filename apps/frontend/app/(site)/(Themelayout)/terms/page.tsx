			...
			<main className={style.main}>
				...
				<div className={style.terms}>
					...
					<p className={style.paragraph}>
						...
						совершения конклюдентных действий, предусмотренных настоящей
						Офертой.
					</p>
					<p className={style.paragraph}>
						Конклюдентные действия — это поведение, которое выражает согласие с
						предложением контрагента заключить, изменить или расторгнуть
						договор. Действия состоят в полном или частичном выполнении условий,
					...
					<p className={style.paragraph}>
						...
						эксперимента по установлению специального налогового режима «Налог
						на профессиональный доход» и оказывает Услуги по настоящему Договору
					...
					<p className={style.paragraph}>
						...
						Федерального закона от 27.11.2018 N 422-ФЗ и обеспечить его передачу
						Заказчику.
					</p>
					<p className={style.paragraph}>
					...
					<p className={style.paragraph}>
						...
						Федерации. Случаи, порядок и условия возврата денежных средств за
						неоказанные (некачественно оказанные) услуги устанавливаются на
						Сайте Исполнителя в сети «Интернет»: icecreammusic.ru. Возврат
						денежных средств осуществляется на основании претензии, срок ответа
					...
					<p className={style.paragraph}>
						4.1. Стоимость услуг Исполнителя, оказываемых Заказчиком и порядок
						их оплаты, определяются на основании сведений Исполнителя при
						оформлении заявки Заказчиком либо устанавливаются на Сайте
						Исполнителя в сети «Интернет»: icecreammusic.ru
					</p>
					<p className={style.paragraph}>
					...
					<p className={style.paragraph}>
						5.4. Такая информация может содержаться в предоставляемых
						Исполнителю локальных нормативных актах, договорах, письмах,
						отчетах, аналитических материалах, результатах исследований, схемах,
					...
					<p className={style.paragraph}>
						7.5 Исполнитель обязуется прекратить предоставление Услуг по
						настоящей Оферте в случае утраты им права применять специальный
						налоговый режим `Налог на профессиональный доход`, в том числе в
						случае снятия Исполнителя с учета в налоговом органе или
						несоответствия требованиям пункта 2 статьи 4 Федерального закона от
						27.11.2018 N 422-ФЗ.
					</p>
					<h1 className={style.pTitle}>8. Срок действия настоящей Оферты</h1>
					<p className={style.paragraph}>
						8.1. Оферта вступает в силу с момента размещения на Сайте
						Исполнителя и действует до момента её отзыва Исполнителем.
					</p>
					<p className={style.paragraph}>
					...
					<p className={style.paragraph}>
						9.5. Бездействие одной из Сторон в случае нарушения условий
						настоящей Оферты не лишает права заинтересованной Стороны
						осуществлять защиту своих интересов позднее, а также не означает
						отказа от своих прав в случае совершения одной из Сторон подобных
