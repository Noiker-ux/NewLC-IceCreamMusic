        ...
        <div className={style.detail}>
          ...
          <div className={style.infoItem}>
            <div className={style.desc}>
              ...
              <MyText className={style.subText}>
                ДДля Авторов музыки и Авторов слов необходимо указать
          ...
          <div className={style.infoItem}>
            <div className={classNames(style.desc, style.mt30)}>
              ...
              <MyText className={classNames(style.subText, style.mb10)}>
                Укажите язык, на котором исполняется трек, если трек без
                вокальной партии в списке выберите «Без слов»
              </MyText>
              <MySelect
                label={"Язык трека"}
                options={[
